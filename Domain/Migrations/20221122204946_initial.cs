        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    List_warrant_type_ID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_acceptanceUser_client_ID = table.Column<int>(type: "int", nullable: true),
                    User_client_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Acceptance_User_client_User_acceptanceUser_client_ID",
                        column: x => x.User_acceptanceUser_client_ID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    List_TV_brands_ID = table.Column<int>(type: "int", nullable: true),
                    List_TV_brand_models_ID = table.Column<int>(type: "int", nullable: true),
                    List_TV_technologies_ID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Warrant_TV", x => x.Warrant_ID);
                    table.ForeignKey(
                        name: "FK_Warrant_TV_List_TV_brand_models_List_TV_brand_models_ID",
                        column: x => x.List_TV_brand_models_ID,
                        principalTable: "List_TV_brand_models",
                        principalColumn: "List_TV_brand_models_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Warrant_TV_List_TV_brands_List_TV_brands_ID",
                        column: x => x.List_TV_brands_ID,
                        principalTable: "List_TV_brands",
                        principalColumn: "List_TV_brands_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Warrant_TV_List_TV_technologies_List_TV_technologies_ID",
                        column: x => x.List_TV_technologies_ID,
                        principalTable: "List_TV_technologies",
                        principalColumn: "List_TV_technologies_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acceptance_ID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pledge_Acceptance_Acceptance_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Acceptance_User_acceptanceUser_client_ID",
                table: "Acceptance",
                column: "User_acceptanceUser_client_ID");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "User_chempe_ID",
                unique: true,
                filter: "[User_chempe_ID] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[User_client_ID] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "User_investor_ID",
                unique: true,
                filter: "[User_investor_ID] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[Pledge_status_ID] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warrant_TV_List_TV_brand_models_ID",
                table: "Warrant_TV",
                column: "List_TV_brand_models_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Warrant_TV_List_TV_brands_ID",
                table: "Warrant_TV",
                column: "List_TV_brands_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Warrant_TV_List_TV_technologies_ID",
                table: "Warrant_TV",
                column: "List_TV_technologies_ID");
